...
set3:  src/aes.o src/histogram.o src/hamming.o src/hex2base64.o src/xor.o src/hex_coder.o src/pkcs.o set3/main.o
	gcc -ggdb src/histogram.c src/hamming.c src/hex2base64.c src/xor.c src/aes.c src/hex_coder.c src/pkcs.c set3/main.c -lm -lcrypto -o set3/main.out
