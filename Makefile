...
set5:  src/aes.o src/histogram.o src/hamming.o src/hex2base64.o src/xor.o src/hex_coder.o src/pkcs.o src/rmath.o src/dh.o src/srp.o set5/main.o
	gcc -ggdb src/aes.c src/histogram.c src/hamming.c src/hex2base64.c src/xor.c src/hex_coder.c src/pkcs.c src/rmath.c src/dh.c src/srp.c set5/main.c -lm -lcrypto -o set5/main.out
